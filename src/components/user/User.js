...
import GitbubContext from '../../context/github/githubContext';

const User = ({ match }) => {
  const gitbubContext = useContext(GitbubContext);
  const { getUser, user, loading, getUserRepos, repos } = gitbubContext;
